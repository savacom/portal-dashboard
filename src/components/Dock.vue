      ...
      <div :class="{'dock-left-container': position === 'left', 'dock-left-container-open': showDock}" class="dock-container w-auto d-flex justify-content-center">
        ...
        <div class="dock d-flex justify-content-center align-items-center">
          <router-link :to="{name: 'home'}">
            <dock-app id="home" name="Домой" :position="position" :active="this.$route.name === 'home'" @click="toggleDock(350)" />
          </router-link>

          <router-link :to="{name: 'app-store'}">
            <dock-app id="app-store" name="Магазин приложений" :position="position" :notifications="appStoreNotifications" :active="this.$route.name === 'app-store' || this.$route.name === 'app-store-app'" @click="toggleDock(350)" />
          </router-link>
          ...
          <dock-app id="mode" :name="darkMode ? 'Светлое оформление' : 'Темное оформление'" :position="position" @click="toggleDarkMode">
