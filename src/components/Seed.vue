<template>
  <div class="px-2 px-sm-4 pb-2 pb-sm-3">
    <!-- <span>Введите пароль, чтобы увидеть вашу seed-фразу из 24 слов</span> -->
    <div class="px-0 px-lg-4" v-if="!showSeed">
      <label class="mb-2">Введите ваш пароль</label>
      <input-password
        v-model="password"
        ref="password"
      ...
      <label v-if="otpEnabled" class="mt-3 mb-0">Введите ваш код двухфакторной аутентификации</label>
      ...
      >
        {{
        isLoadingSeed ? "Расшифрока мнемонической фразы..." : "Показать мнемоническую фразу"
        }}
      </b-button>
    </div>
